<template>
  <div class="seo-optimizer">
    <div class="mb-6">
      <h2 class="text-2xl font-bold mb-4">Otimizador SEO de Conteúdo</h2>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <!-- Input Section -->
      <div class="card">
        <h3 class="text-xl font-bold mb-4">Seu Conteúdo</h3>
        <div class="space-y-4">
          <div>
      ...
      <!-- Results Section -->
      <div class="card">
        <h3 class="text-xl font-bold mb-4">Análise SEO</h3>
        ...
        <div v-if="analysis && !loading" class="space-y-6">
          ...
          <!-- Keyword Density -->
          <div>
            <h4 class="font-bold mb-3">Densidade de Palavras-chave</h4>
            <div class="space-y-2">
              <div 
          ...
          <div v-if="suggestions && suggestions.length > 0">
            <h4 class="font-bold mb-3">Sugestões de Melhoria</h4>
            <ul class="space-y-2">
              <li 
          ...
          <div v-if="metaDescription">
            <h4 class="font-bold mb-2">Meta Description Sugerida</h4>
