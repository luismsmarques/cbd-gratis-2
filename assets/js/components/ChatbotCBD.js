/**
 * Chatbot Component for CBD General (Vue 3 - CDN Version)
...
window.ChatbotCBD = {
  template: `
    <div class="chatbot-container">
          ...
          <div class="assistant-message">
            ...
            <div class="message-content">
              ...
              <div class="message-text">
                Olá! Sou a sua IA Especialista em CBD. Posso ajudar com questões sobre dosagem, benefícios, segurança, legalidade, uso em animais ou humanos, e muito mais. Qual é a sua primeira pergunta?
              </div>
            </div>
          </div>
          
          <!-- Prompt Starters - MUI Chips -->
          <div class="prompt-starters" style="margin-top: 24px;">
            <h4 class="mui-typography-subtitle1" style="margin-bottom: 12px; color: var(--mui-gray-600);">💡 Sugestões de Perguntas:</h4>
      ...
      <!-- Input Form - MUI Text Field -->
      <form @submit.prevent="sendMessage" class="chat-input-form" style="margin-top: 24px;">
        <!-- Main Input - MUI Text Field -->
        <div class="mui-text-field" style="display: flex; gap: 8px; align-items: flex-end;">
          ...
          <button 
            ...
            style="min-width: 48px; height: 48px; padding: 0; display: flex; align-items: center; justify-content: center;"
          >
            <svg v-if="!loading" style="width: 20px; height: 20px;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8"/>
            </svg>
            <div v-else style="width: 20px; height: 20px; border: 2px solid currentColor; border-top-color: transparent; border-radius: 50%; animation: spin 1s linear infinite;"></div>
          </button>
        </div>
        
        <!-- Disclaimer - MUI Alert -->
        <div class="mui-alert mui-alert-warning" style="margin-top: 16px;">
  ...
  data() {
    return {
      ...
      promptStarters: [
        'Qual a dosagem inicial para um gato de 5kg?',
        'O CBD é legal em Portugal para uso pessoal?',
        'Quais os efeitos secundários do CBD para ansiedade?',
        'Como calcular a dosagem de CBD para cães?',
...
const ChatbotCBD = window.ChatbotCBD;
