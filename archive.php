...
<div class="content-area">
	<header class="archive-header mb-8">
		<?php
		the_archive_title( '<h1 class="text-3xl md:text-4xl font-bold mb-4">', '</h1>' );
		the_archive_description( '<div class="text-gray-600">', '</div>' );
		?>
	</header>
	...
	<?php else : ?>
		<div class="text-center py-12">
			...
			<p class="text-gray-600">Não há posts nesta categoria ainda.</p>
		</div>
	<?php endif; ?>
</div>
